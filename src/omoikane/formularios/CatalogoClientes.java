...
public class CatalogoClientes extends javax.swing.JInternalFrame {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if(IDArticulo != -1) {
            ...
            if(JOptionPane.showConfirmDialog(null, "¿Realmente desea eliminar éste Cliente: \""+descripcion+"\"?", "lala", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
                omoikane.principal.Clientes.eliminarCliente(IDArticulo);
            }
        }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if(IDArticulo != -1) { omoikane.principal.Clientes.lanzarModificarCliente(IDArticulo); }
    ...
    private void btnDetallesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetallesActionPerformed
        ...
        //Lanzar la ventana de detalles:
        if(IDArticulo != -1) { omoikane.principal.Clientes.lanzarDetallesClientes(IDArticulo); }
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        // TODO add your handling code here:
        omoikane.principal.Clientes.lanzarImprimir(this);
